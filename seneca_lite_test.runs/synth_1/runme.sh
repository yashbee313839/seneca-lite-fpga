...
HD_PWD='C:/Users/yashb/seneca-test/seneca_lite_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seneca_lite_single_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seneca_lite_single_core.tcl
